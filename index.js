...
function getTextFromAnimatorDiv(url) {
    return __awaiter(this, void 0, void 0, function () {
        var data, $, text, error_1;
...
getTextFromAnimatorDiv(url).then(function (text) {
    if (text) {
        console.log("Text from \"animator\" div: ".concat(text));
    }
    else {
